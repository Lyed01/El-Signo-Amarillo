label branch_escape_scene21:
    ...
    tessie "(sin apartar la vista del libro) “...cuando los ojos del rey se abran, no habrá más aurora…”"
    tessie "(sonríe, nerviosa) Cada página parece escrita para asustar a quien la lee."

    scott "(con voz baja, distante) Deja de leer, Tessie… por favor."
    ...
    scott "No… no debería haberse detenido."
    ...
    tessie "¿Nos quedamos sin nafta?"

    scott "No… Esto no es normal."
    ...
    tessie "(voz apenas audible) Scott… escuchá."
