label esc_13C_3:
    ...
    scene bg iglesia_interior with fade   # ← reemplazo correcto del fondo
    ...
    n "Avanzaron unos metros más, hasta el altar."
    n "Entre los escombros, una trampilla semienterrada se adivinaba bajo losas rotas y fragmentos de madera."
    ...
    n "El chirrido de la bisagra al levantar la trampilla resonó en toda la nave, como un lamento metálico que pareció despertar algo dormido bajo el suelo."
