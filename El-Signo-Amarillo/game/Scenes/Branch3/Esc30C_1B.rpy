label esc_30C_1B:
    ...
    n "La realidad y el sueño se fundieron. La escena que Tessie había descrito ahora lo contenía."
    n "El corazón de Scott latía al ritmo del motor."
    ...
    play sound "sfx_puerta_metalica.ogg"
    n "Los soldados descendieron del vehículo, sus figuras recortadas contra la niebla."

    n "Lo rodearon con eficacia mecánica, lo sujetaron de los brazos sin una palabra."
    n "Scott no resistió. La lluvia lo empapaba, la ciudad lo observaba."
    ...
    n "El pasado que habían tocado y el presente que los oprimía eran ahora una sola trampa."

    n "La noche se cerró sobre la ciudad, lluviosa, silenciosa, devolviendo a las sombras su dominio absoluto."

    n "Solo quedaron la bruma, el eco del metal, y la certeza de que el régimen controlaba cada sombra."
